1. ¿Qué es una aplicación web distribuida?
a) Una aplicación que solo funciona sin internet
b) Una aplicación que se ejecuta en un único servidor
...
b) Un sistema que permite la comunicación entre aplicaciones a través de la red
c) Un archivo HTML
...
b) Un formato de intercambio de datos
c) Un servidor web
...
a) Un archivo HTML
b) Una URL donde se accede a un servicio
